...
import { ArrowDown, Briefcase, User, Mail, Sparkles, Layers, Code as CodeIcon } from 'lucide-react'; // Renamed Code to CodeIcon
...
export default function HomePage() {
  ...
  return (
    <div className="fade-in-page overflow-x-hidden">
      {/* Hero Section */}
      <section className="min-h-[calc(100vh-4rem)] flex items-center relative overflow-hidden py-16 sm:py-20 bg-gradient-to-br from-background via-sky-50 to-indigo-100">
        <div className="container mx-auto px-4 z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="animate-slideInUp text-center md:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-headline font-bold mb-5 text-gray-800">
                Hi, I&apos;m <span className="text-primary">Nitin Kumar</span>
              </h1>
              <p className="text-xl sm:text-2xl font-medium mb-6 text-gray-700">
                Full Stack Developer & AI Enthusiast
              </p>
              <p className="text-base text-gray-600 max-w-lg mx-auto md:mx-0 mb-10 leading-relaxed">
            ...
            <div className="hidden md:flex justify-center items-center animate-slideInUp delay-200">
              <Image 
                ...
                data-ai-hint="professional developer portrait abstract"
                priority
              />
            </div>
          </div>
      ...
      {/* About Me Section */}
      <section id="about-section" className="section-padding bg-slate-50">
            ...
            {[
              ...
              <Card key={item.title} className="bg-card text-center p-6 animate-slideInUp shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: `${0.2 + index * 0.1}s`, opacity: 0 }}>
                <CardContent className="p-0">
                  ...
                  <h3 className="text-lg font-semibold text-gray-700 mb-1.5">{item.title}</h3>
      ...
      <section className="section-padding bg-slate-50">
        <div className="container mx-auto px-4 text-center">
            <div className="max-w-2xl mx-auto animate-slideInUp">
                <h2 className="text-3xl sm:text-4xl font-bold mb-5 text-gray-800">
                ...
                <Button asChild size="lg" className="bg-secondary hover:bg-secondary/90 text-secondary-foreground shadow-lg hover:shadow-secondary/30 transition-all duration-300 transform hover:scale-105 px-8 py-3.5 text-md">
                    <Link href="/contact">
